...
<div style='text-align: center; background: linear-gradient(135deg, #004e92 0%, #000428 100%); padding: 20px; border-radius: 10px; color: white; margin-bottom: 20px;'>
    ...
    <p style='margin-top:10px;'>Tác giả: Thầy Phạm Đức Quân - TH Yên Lâm I</p>
</div>
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Đức Quân - Trường Tiểu học Yên Lâm I - ĐT: 098 597 4076</div>", unsafe_allow_html=True)
